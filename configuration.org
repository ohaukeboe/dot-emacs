...
#+begin_src elisp
  (setq-default oskah/evil-lookup-procs '(eldoc))
...
#+begin_src elisp
  (use-package parinfer-rust-mode
    ...
    ((emacs-lisp-mode) .
     (lambda ()
       (setq-local oskah/evil-lookup-procs (copy-sequence
                                            oskah/evil-lookup-procs))
       (add-to-list 'oskah/evil-lookup-procs 'helpful-at-point)
...
#+begin_src elisp
  (use-package c-mode
    ...
    :general
    (oskah/leader-keys '(c-mode-map c-ts-mode-map)
      "mc" 'project-compile)
    :hook
    ...
    ((c-mode c++-mode c-ts-mode c++-ts-mode) .
     (lambda ()
       ...
       (setq-local oskah/evil-lookup-procs (copy-sequence
                                            oskah/evil-lookup-procs))
       (add-to-list 'oskah/evil-lookup-procs 'oh/consult-man-at-point))) ;'woman-follow)))
    :init
    (with-eval-after-load 'org
...
#+begin_src elisp
  (use-package cargo
    ...
    :general
    (oskah/leader-keys rust-mode-map
...
# Local Variables:
# jinx-local-words: "Direnv Flycheck Imenu Ripgrep Vundo eshell svg"
# End:
