...
[cite:@tanenbaumModernOperatingSystems2015]
...
together. It is also necessary to install =hunspell-en_us= and =hunspell-nb=.

If the spell checker makes the cursor hang, it can be useful to setup
[[https://github.com/rolandwalker/flyspell-lazy][flyspell-lazy]] which delays the spellchecker until Emacs has been idle for some
time.
...
#+begin_src elisp
  ...
  (use-package flyspell-correct
    ...
    (oskah/leader-keys
      ...
      "S c" '(flyspell-correct-wrapper :which-key "correct")))
