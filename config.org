...
#+begin_src elisp
  (use-package doom-modeline
    ...
    '(compilation objed-state misc-info persp-name battery grip irc mu4e gnus github debug repl lsp minor-modes input-method indent-info buffer-encoding process check vcs time buffer-position))
  ...
  (doom-modeline-def-modeline 'org-src
    ...
    '(compilation objed-state misc-info debug lsp minor-modes input-method indent-info buffer-encoding process check time buffer-position))
