...
#+begin_src elisp
  (defvar my/nextcloud-dir (let ((path "~/Nextcloud"))
...
#+begin_src elisp
  (use-package org-roam
    ...
    (org-roam-directory (file-truename (my/nextcloud-dir-expand "org_notes/roam")))
    (org-roam-dailies-directory (file-truename (my/nextcloud-dir-expand "org_notes/daily")))
    :bind
