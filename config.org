...
#+begin_src elisp
  (use-package org
    ...
    (org-capture-templates
     '(("t" "Todo" entry (file+headline org-default-notes-file "Elfeed")
        "* TODO %?\n  %i\n  %a")
       ("e" "Elfeed entry" entry
        (file+headline org-default-notes-file "Elfeed")
        "* %:title\n:PROPERTIES:\n:ADDED: %U\n:FEED: %:feed-title\n:DATE: %:date-timestamp\n:LINK: %:external-link\n:END:\n%i\n#+begin_quote\n%:content\n#+end_quote\n\n%?")))

    (org-agenda-custom-commands
     '(("e" "Elfeed entries" search "Elfeed"
        ((org-agenda-files (list org-default-notes-file))
            (org-agenda-skip-function '(org-agenda-skip-entry-if 'notregexp "Elfeed"))))))
...
** gptel
Use any LLM in Emacs. I have also added GitHub Models which allows to use any of the models available at the [[https://github.com/marketplace/models][Marketplace]] using just one api key.
