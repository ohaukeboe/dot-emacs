...
#+begin_src elisp :tangle early-init.el
  ;; -*- lexical-binding: t; -*-
  ;; Nix's subdirs.el already puts all package dirs on load-path; prevent
  ;; package.el from treating the Nix store paths as system package dirs,
  ;; which would cause "activated too late" warnings for every Nix package.
